...
import {
  ...
  TransportError,
} from '@core/sync/SupabaseSyncTransport';
import { isNetworkFetchError } from '@core/sync/networkError';
...
import { MockSyncServer } from '@core/sync/__tests__/mockServer';
...
} from '@core/sync/connectGuard';
import { PLACEHOLDER_USERNAME } from './placeholderUser';
import type { WorkerMessage } from '../api/rpc';
...
export class SyncManager {
  ...
  private readonly notify: (message: WorkerMessage) => void;

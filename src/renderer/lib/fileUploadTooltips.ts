...
export const FILE_UPLOAD_HINT_INVENTORY_ATTRIBUTES =
  'Excel: header row with Id (preferred) or Name to match items, plus Description, Description (Urdu), and/or attribute columns (by label or key). Empty cells clear that field. Columns not present are left unchanged.\nFiles: .xlsx, .xls, .csv.';

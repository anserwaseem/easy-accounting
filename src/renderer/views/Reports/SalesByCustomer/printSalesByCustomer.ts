...
const buildGroupHtml = (rows: SalesByCustomerItem[]): string => `
...
/** prints sales-by-customer item table in a hidden iframe (full row list). */
...
<head>
  ...
  <style>
    ...
    .sbc-print-title { text-align: center; font-size: 12px; font-weight: 700; margin-bottom: 8px; page-break-after: avoid; }
...
<body>
  <div class="sbc-print-title print-header">${title}</div>
